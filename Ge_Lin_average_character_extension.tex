...
\begin{definition}[boundary-corrected average character]
...
\begin{lemma}[non-negativity of the correction]
...
\begin{lemma}[obstruction equals corrected surplus]
...
\begin{theorem}[average character criterion]
Let $(X,\T,\Phiw)$ be a weighted triangulated closed surface with
...
\begin{corollary}[Ge--Lin's pointwise criterion]
If
\[
  L_i(\T,\Phiw)>2\pi
  \qquad (i\in V),
...
\begin{corollary}[lower average character criterion]
...
\begin{corollary}[only potentially bad subsets need checking]
...
\begin{corollary}[constant weight formula]
...
\begin{corollary}[tangent circle packings]
...
\begin{corollary}[constant weight, pointwise degree criterion]
...
\begin{corollary}[arbitrary weight, pointwise degree criterion]
...
\begin{corollary}[constant weight, large-set lower average degree criterion]
